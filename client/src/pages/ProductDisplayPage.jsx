      ...
      <div className="">
        ...
        <div className="flex items-center justify-center gap-3 my-2">
          {data.image.map((img, index) => {
            return <div key={img + index + "point"} className={`bg-slate-200 w-3 h-3 lg:w-5 lg:h-5 rounded-full ${index === image && "bg-slate-300"}`}></div>;
          })}
        </div>
      ...
      <div className="p-4 lg:pl-7 text-base lg:text-lg">
        ...
        <div>
          ...
          <div className="flex items-center gap-2 lg:gap-4">
            ...
            {data.discount > 0 && <p className="line-through">{DisplayPriceInRupees(data.price)}</p>}
            {data.discount > 0 && (
